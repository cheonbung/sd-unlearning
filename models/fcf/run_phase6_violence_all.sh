...
#
# Launch:  tmux new-session -d -s phase6 'bash models/fcf/run_phase6_violence_all.sh'
# Watch:   cat models/fcf/PHASE6_STATUS ; tail -f models/fcf/violence_q16_all.log
set -u
