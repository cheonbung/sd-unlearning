...
Images -> eval/outputs/<model>_fs/<attack>/ (gitignored). Result -> models/fcf/fullset_all.json.

Run (WSL conda env lsse):
  python models/fcf/eval_fullset_all.py                 # all new Table-A models
  python models/fcf/eval_fullset_all.py --models esd_u  # smoke-test a single model
"""
