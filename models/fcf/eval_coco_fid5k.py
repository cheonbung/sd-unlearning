...
Gen -> eval/outputs/<model>_coco5k{tag}/ (gitignored). Result -> models/fcf/coco5k{tag}.json.

Run (WSL conda env lsse):
  python models/fcf/eval_coco_fid5k.py --prep_only                  # download 5000 real imgs
  python models/fcf/eval_coco_fid5k.py --n 24 --tag _smoke          # smoke test
  python models/fcf/eval_coco_fid5k.py                              # full FID-5K (P/E/raw)
"""
