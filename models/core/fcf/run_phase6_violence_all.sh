...
#
# Launch:  tmux new-session -d -s phase6 'bash models/core/fcf/run_phase6_violence_all.sh'
# Watch:   cat models/core/fcf/PHASE6_STATUS ; tail -f models/core/fcf/violence_q16_all.log
set -u
