...
Run (WSL conda env lsse):
  python models/comparison/esd/train_esd.py --config models/comparison/esd/configs/nudity_esd_u.yaml
...
def main():
    ...
    out_dir = Path(cfg.get("output_dir", "models/comparison/esd/outputs/esd_u"))
