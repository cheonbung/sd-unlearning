...
ATTACK_ROOTS = {
    ...
    "esd_u":      REPO / "eval/outputs/esd_u/attacks",
    "sld_medium": REPO / "eval/outputs/sld_medium/attacks",
    "safeclip":   REPO / "eval/outputs/safeclip/attacks",
    ...
    "fcf_p_official": REPO / "eval/outputs/fcf_p_official/attacks",
    "fcf_e_official": REPO / "eval/outputs/fcf_e_official/attacks",
    ...
    "odace_v15":    REPO / "eval/outputs/odace_v15/attacks",
    "odace_v2":     REPO / "odace/outputs/eval/odace/images/fcf_nudity",
    "safe_neg":     REPO / "eval/outputs/safe_neg/attacks",
    "raw_v15":      REPO / "eval/outputs/raw_v15/attacks",
    "sd21base":     REPO / "eval/outputs/sd21base/attacks",
    "sld_max":      REPO / "eval/outputs/sld_max/attacks",
    "sld_strong":   REPO / "eval/outputs/sld_strong/attacks",
