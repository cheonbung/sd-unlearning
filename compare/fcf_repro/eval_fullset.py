...
Images -> xmodel/outputs/<model>_fs/<attack>/ (gitignored). Result -> compare/fcf_repro/fullset_eval.json.
Run (WSL conda env lsse):  python compare/fcf_repro/eval_fullset.py
"""
...
def main():
    ...
    for model in MODELS:
        ...
        for key, pfile, sub in ATTACKS:
            ...
            od = REPO / "xmodel" / "outputs" / f"{model}_fs" / sub
